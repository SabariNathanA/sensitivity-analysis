...
for fileid=1:1
    a= 'C:\Users\AnbalaganSN\Documents\Sabari\MATLAB_src\channel_quality/cc_50grid_5mhzbw_20dB_3500MHz_10cmps_';
    z='.mat';
...
%     Thr_perf_10p(fileid,1) = prctile(Thr_perf(:,1),10);
...
save('ppOLLA_BLER_20_embb_10cmps','PDR_optimal_wolla_10p','Thr_optimal_wolla_10p', 'PDR_optimal_woutolla_10p','Thr_optimal_woutolla_10p','PDR_OLLA_10p' ,'Thr_OLLA_10p');
%     sigma_stepsize = 0.5;
%     sigma_count = 20;
%     
